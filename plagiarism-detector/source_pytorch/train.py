...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--input-features', type=int, default=3, metavar='IND',
                        help='number of input features (default: 3)')
    parser.add_argument('--hidden-dim', type=int, default=200, metavar='HID',
                        help='number of hidden dimensions (default: 200)')
    parser.add_argument('--output-dim', type=int, default=1, metavar='OUTD',
